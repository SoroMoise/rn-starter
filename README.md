...
- **Contextual paywall** — triggers on generic action count (`engagementStorage.getActionCount / incrementAction`), never during the first session — no business logic baked in
